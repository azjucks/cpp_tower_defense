...
enum GPTextAlignmentFlags
{
    ...
    GP_TEXTALIGN_CENTER   = 1 << 1,
    GP_TEXTALIGN_BASELINE = 1 << 2,
    GP_TEXTALIGN_BOTTOM   = 1 << 3,
    GP_TEXTALIGN_TOP      = 1 << 4,
    GP_TEXTALIGN_LEFT     = 1 << 5,
    GP_TEXTALIGN_RIGHT    = 1 << 6,
};
...
GP_API float gpMouseWheelOffset(GPLib* gp);
